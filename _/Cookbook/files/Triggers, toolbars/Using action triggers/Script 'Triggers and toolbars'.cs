...
///
/// Triggers and toolbars are active only when the script is running. When the program creates the folder, it also sets to run the script at program startup (Options -> Workspace -> Run scripts...). Need to restart it (click the Run button) to apply changes after editing triggers or toolbars.
/// 
