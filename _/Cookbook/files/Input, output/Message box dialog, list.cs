/// To quickly insert code for <see cref="dialog.show"/> and other <see cref="dialog"/> functions, use snippet <b>dsDialogShowSnippet<>: type <.c>ds<> and select from the list.
