/// To run a script when the editor program starts (actually whenever this workspace loaded), add it in Options -> Workspace -> Run script when this workspace loaded. Use path like <mono>\Folder\Script.cs<> or name like <mono>Script123.cs<>. Can be several scripts in separate lines. To temporarily disable a script, prepend <mono>//<>, like <mono>//\Folder\Script.cs<>.
