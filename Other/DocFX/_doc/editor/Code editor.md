...
<!--
To generate TOC with #links, can be used the VS context menu command "Generate TOC". Then remove the indentation.
...
To select a symbol, click or use arrow/page/Enter keys.
...
The program comes with a database of Windows API declarations, and helps to find and insert them. More info: menu Code -> Windows API -> [?].
