# Dialog - libraries of controls and themes
This example uses library <a href='https://www.google.com/search?q=HandyControl'>HandyControl</a>. NuGet: <u title='Paste the underlined text in menu -> Tools -> NuGet'>HandyControl</u>. Applies its theme to all controls and adds several its controls to the dialog.
