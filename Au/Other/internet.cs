...
namespace Au.Types {
	...
	public static class ExtInternet {
		...
		/// <remarks>
		/// By default <b>HttpClient</b> and similar functions download content to a memory buffer before returning. To avoid it, use <i>completionOption</i> <see cref="HttpCompletionOption.ResponseHeadersRead"/>, or <see cref="Get(HttpClient, string, bool, string[], string, Action{HttpRequestMessage})"/> with <i>dontWait</i> true. Then call this function (it will download the file), and finally dispose the <b>HttpResponseMessage</b>.
		/// </remarks>
