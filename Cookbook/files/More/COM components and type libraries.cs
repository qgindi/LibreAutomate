...
/// - In the <b>Find in lists<> field type <q>shell<> (optionally, just to make the list smaller).
...
/// - Click <b>OK<>. It adds a comment line like <q>/*/ com Shell32 ...; /*/<> in the script.
/// - Below that line press <mono>Ctrl+Space<> and you'll see namespace <q>Shell32<> added to the list. Use it like any other namespace.
...
/// Notes:
/// - To create objects, use interfaces (like <q>Shell<> in the above example). Not classes like <q>ShellClass<>.
...
/// - In other scripts you can use the same .NET assembly (don't need to convert again). Either copy-paste the <q>/*/ com Shell32 ...; /*/<>, or in the <b>Properties<> dialog click the <b>...<> button and select from submenu <b>Use converted<>. Or convert again, it does not harm.
