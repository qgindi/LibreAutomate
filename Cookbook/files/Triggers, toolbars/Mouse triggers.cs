...
///
/// To add a trigger can be used snippet <.x>triggerSnippet<> or menu <b>TT > New trigger<>. Add triggers in function <.x>MouseTriggers<> in file <.c>Mouse triggers<>; you'll find examples there.
///
