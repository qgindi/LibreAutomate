...
/// This code gets a password. Here <q>"test"<> is not a password; it's a password's name. The password is saved in a file (encrypted).
...
/// - Use the password manager dialog: run the password manager source file (<q>Passwords.cs<>) or call <b>Passwords.ShowManagerUI<>.
