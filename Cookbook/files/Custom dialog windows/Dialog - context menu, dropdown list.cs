/// To show a context menu or drop-down list can be used class <see cref="popupMenu"/>. Or WPF class <.x>ContextMenu<>, but it can't have many items (slow, no scrollbar). To create <.x>popupMenu<> code can be used snippet <.x>menuSnippet<>.
