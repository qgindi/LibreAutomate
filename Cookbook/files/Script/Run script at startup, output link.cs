/// To run a script when the editor program starts (actually whenever this workspace loaded), add it in <b>Options > Workspace > Run scripts when workspace loaded<>. Use path like <q>\Folder\Script.cs<> or name like <q>Script123.cs<>. Can be several scripts in separate lines. To temporarily disable a script, prepend <q>//<>, like <q>//\Folder\Script.cs<>.
