...
void Editor::SetScrollBars() {
	...
	// _TODO: ensure always showing as many lines as possible
...
void Editor::ButtonDownWithModifiers(Point pt, unsigned int curTime, KeyMod modifiers) {
	...
	//Au: commented out. QM2 uses Ctrl+click for multiple selections, see below.
...
void Editor::TickFor(TickReason reason) {
	...
	case TickReason::scroll:
		...
		//au: https://sourceforge.net/p/scintilla/bugs/2443/
           if (HaveMouseCapture()) {
               ButtonMoveWithModifiers(ptMouseLast, 0, KeyMod::Norm);
           } else {
